//
//  MethodTabbedPage.swift
//  TriosTouchscreenDemo
//
//  Created by stephen eshelman on 7/4/16.
...
class MethodTabbedPage: UIViewController, IMercuryPage
{
   @IBOutlet var _segmentedControl: UISegmentedControl!
   
   var _methodController:UIViewController!
   var _sampleInfoController:UIViewController!
   var _methodPage:IMercuryPage!
   var _sampleInfoPage:IMercuryPage!
   ...
   override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?)
   {
      if (segue.identifier == "EmbedSegue")
      {
         ...
         _methodController = self.storyboard?.instantiateViewControllerWithIdentifier("MethodPage")
         _methodPage = _methodController as! IMercuryPage
         
         _sampleInfoController = self.storyboard?.instantiateViewControllerWithIdentifier("SampleInfoPage")
         _sampleInfoPage = _sampleInfoController as! IMercuryPage
   ...
   @IBAction func _segmentedControlValueChanged(sender: AnyObject)
   {
      ...
      {
      case 0:
         nextController = _methodController
         currentController = childViewControllers.last! as UIViewController
         break
      case 1:
         nextController = _sampleInfoController
         currentController = childViewControllers.last! as UIViewController
         break
      default:
         return
